      ...
      <div className="main-container">
		...
		<div className="primary-content">
			...
			<div className="carousel">
				...
				<Route path="/vegas" render={() => <Content title='High School Graduation Trip to Las Vegas' id='72157687042225613' page= '37' background='vegas' color='lightblue' />}/>
				<Route path="/hawaii" render={() => <Content title='Mahalo Fora Maui' id='72157686468511520' page= '76' background='hawaii' color='#FF9933' />  }/>
